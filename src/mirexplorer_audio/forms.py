...
from mirexplorer_audio.storage import AUDIO_FILE_FORMATS, MAX_SIZE, MAX_AUDIO_DURATION
...
class AudioUploadInternal(AudioUpload):
	"""Same validators as ``AudioUpload`` but no CSRF (internal service-to-service POST)."""
